...
*Each row of table 6 corrisponds to a country, it's sample size, and the percentages of it's respondents religous attitudes; one row per country.  Each row of athesim corresponds to a nationality, a responce, and a year; one row per respondent*  
...
*While the z score for 95% is 1.96, and if p is at maximum 0.5:*
