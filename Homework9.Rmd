...
*birth weight = 123.05 - smoke X 8.94*
...
*There is not really a slope, such as there are two possible values.  Birth weight for smoke = 0 would be 123.05, and for smoke = 1 would be 131.99*

(c) Is there a statistically significant relationship between the average birth weight and smoking?

*Yes, the p-value for that variable rounds to 0.*
...
*non-aborigionals will miss 9.11 days less on average, males will miss 3.1 days more on average, and slow-learners will miss 2.15 days more on average.*


(c) Calculate the residual for the first observation in the data set: a student who is aboriginal, male, a slow learner, and missed 2 days of school.

*Expected = 18.93 + 3.10 + 2.15 = 24.18*
...
*Probability of a damaged O-ring @ temp = e^(11.6630 -0.2162 X temp) / 1 + e^(11.6630 -0.2162 X temp)*
